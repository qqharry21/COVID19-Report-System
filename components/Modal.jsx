...
const Modal = () => {
  return (
    <div
      className='absolute z-50 p-8 bg-white border border-blue-100 shadow-lg rounded-2xl'
      role='alert'>
      <div className='items-center sm:flex'>
        ...
        <p className='mt-3 text-lg font-medium sm:mt-0 sm:ml-3'>Youve got a new message</p>
      </div>
